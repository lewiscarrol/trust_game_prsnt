...
array { LOOP $t 10; $k = '$t+1'; box {height = 42; width = 140; color = 0,0,0;} "red10_$k"; ENDLOOP; } rex;
...
begin 
	...
	cursor10.set_part_y( 1, stick.y() );
		...
		if (stick.y()>seq10[1]) 
		then rex[1].set_color(255,0,0); 
			dollar_2.set_caption("$1"); dollar_2.redraw(); 
			dollar_3.set_caption("$9"); dollar_3.redraw();
		elseif (stick.y()<seq10[1]) then rex[1].set_color(0,0,0);
		end;
		if (stick.y()>seq10[2]) 
		then rex[2].set_color(255,0,0); 
			dollar_2.set_caption("$2"); dollar_2.redraw(); 
			dollar_3.set_caption("$8"); dollar_3.redraw();
		elseif (stick.y()<seq10[2]) then rex[2].set_color(0,0,0);
		end;
		if (stick.y()>seq10[3])  
		then rex[3].set_color(255,0,0); 
			dollar_2.set_caption("$3"); dollar_2.redraw(); 
			dollar_3.set_caption("$7"); dollar_3.redraw();
		elseif (stick.y()<seq10[3]) then rex[3].set_color(0,0,0);
		end;
		if (stick.y()>seq10[4])  
		then rex[4].set_color(255,0,0); 
			dollar_2.set_caption("$4"); dollar_2.redraw(); 
			dollar_3.set_caption("$6"); dollar_3.redraw();
		elseif (stick.y()<seq10[4]) then rex[4].set_color(0,0,0);
		end;
		if (stick.y()>seq10[5])  
		then rex[5].set_color(255,0,0); 
			dollar_2.set_caption("$5"); dollar_2.redraw(); 
			dollar_3.set_caption("$5"); dollar_3.redraw();
		elseif (stick.y()<seq10[5]) then rex[5].set_color(0,0,0);
		end;
		if (stick.y()>seq10[6])  
		then rex[6].set_color(255,0,0); 
			dollar_2.set_caption("$6"); dollar_2.redraw(); 
			dollar_3.set_caption("$4"); dollar_3.redraw();
		elseif (stick.y()<seq10[6]) then rex[6].set_color(0,0,0);
		end;
		if (stick.y()>seq10[7])  
		then rex[7].set_color(255,0,0); 
			dollar_2.set_caption("$7"); dollar_2.redraw(); 
			dollar_3.set_caption("$3"); dollar_3.redraw();
		elseif (stick.y()<seq10[7]) then rex[7].set_color(0,0,0);
		end;
		if (stick.y()>seq10[8])  
		then rex[8].set_color(255,0,0); 
			dollar_2.set_caption("$8"); dollar_2.redraw(); 
			dollar_3.set_caption("$2"); dollar_3.redraw();
		elseif (stick.y()<seq10[8]) then rex[8].set_color(0,0,0);
		end;
		if (stick.y()>seq10[9])  
		then rex[9].set_color(255,0,0); 
			dollar_2.set_caption("$9"); dollar_2.redraw(); 
			dollar_3.set_caption("$1"); dollar_3.redraw();
		elseif (stick.y()<seq10[9]) then rex[9].set_color(0,0,0);
		end;
		if (stick.y()>seq10[10])  
		then rex[10].set_color(255,0,0); 
			dollar_2.set_caption("$10"); dollar_2.redraw(); 
			dollar_3.set_caption("$0"); dollar_3.redraw();
		elseif (stick.y()<seq10[10]) then rex[10].set_color(0,0,0);
		end;
		cursor10.present();
end;
