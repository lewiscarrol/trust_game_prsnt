...
box { height = 42; width = 140; color = 0,255,0; } zero;
...
begin
	...
	else zero.set_color(0,255,0); 
	end;
	if (stick.y()>-220) then red10_1.set_color(255,0,0);
	elseif (stick.y()<-220) then red10_1.set_color(0,0,0);
	end;
	if (stick.y()>-176) then red10_2.set_color(255,0,0);
	elseif (stick.y()<-176) then red10_2.set_color(0,0,0);
	end;
	if (stick.y()>-132) then red10_3.set_color(255,0,0);
	elseif (stick.y()<-132) then red10_3.set_color(0,0,0);
	end;
	if (stick.y()>-88) then red10_4.set_color(255,0,0);
	elseif (stick.y()<-88) then red10_4.set_color(0,0,0);
	end;
	if (stick.y()>-44) then red10_5.set_color(255,0,0);
	elseif (stick.y()<-44) then red10_5.set_color(0,0,0);
	end;
	if (stick.y()>0) then red10_6.set_color(255,0,0);
	elseif (stick.y()<0) then red10_6.set_color(0,0,0);
	end;
	if (stick.y()>44) then red10_7.set_color(255,0,0);
	elseif (stick.y()<44) then red10_7.set_color(0,0,0);
	end;
	if (stick.y()>88) then red10_8.set_color(255,0,0);
	elseif (stick.y()<88) then red10_8.set_color(0,0,0);
	end;
	if (stick.y()>132) then red10_9.set_color(255,0,0);
	elseif (stick.y()<176) then red10_9.set_color(0,0,0);
	end;
	if (stick.y()>176) then red10_10.set_color(255,0,0);
